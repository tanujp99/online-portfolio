  ...
  return (
    <section id="githubprofile" className="py-8 sm:py-12 md:py-16">
      <div className="container mx-auto px-4 sm:px-6 md:px-8">
        ...
        >
          {/* Profile Header */}
          <div className="bg-white/80 dark:bg-white/5 backdrop-blur-md rounded-2xl p-3 sm:p-4 border border-neutral-200/50 dark:border-neutral-800/50 mb-8">
          ...
          <div className="bg-white/80 dark:bg-white/5 backdrop-blur-md rounded-2xl p-3 sm:p-4 border border-neutral-200/50 dark:border-neutral-800/50 mb-8">
            <div className="flex justify-center gap-4 flex-col lg:flex-row lg:items-center">
              {/* Calendar (scrollable on all screens if needed) */}
              <div className="w-full overflow-x-auto flex justify-center custom-scrollbar" style={{ WebkitOverflowScrolling: 'touch' }}>
                <div className="pb-4 lg:pb-0 w-full" style={{ minWidth: '350px' }}>
              ...
              <div className="lg:hidden flex justify-end w-full mt-4">
              ...
              <div className="hidden lg:flex flex-col items-center justify-center ml-4">
                {Array.from({ length: 7 }, (_, i) => {
                  const year = new Date().getFullYear() - i;
                  return (
                    <button
                      key={year}
                      className={`px-3 py-1 my-1 rounded text-sm font-medium transition-colors duration-150 ${selectedYear === year ? 'bg-light-accent text-white dark:bg-gumroad-pink dark:text-white' : 'bg-transparent text-[rgb(var(--foreground-rgb))] hover:bg-light-accent/10 dark:hover:bg-gumroad-pink/20'}`}
          ...
          <div className="bg-white/80 dark:bg-white/5 backdrop-blur-md rounded-2xl p-3 sm:p-4 border border-neutral-200/50 dark:border-neutral-800/50 mb-8">
            <div className="prose dark:prose-invert max-w-none">
              ...
              <div className="flex justify-center mb-8">
                <img
                  src="https://readme-typing-svg.herokuapp.com?color=%232FDE98&size=22&center=true&vCenter=true&width=450&lines=Code+%26+Coffee+is+Bliss"
                  alt="Typing SVG"
                ...
                {pinnedRepos.map((repo) => (
                  ...
                  >
                    <div className="flex items-start justify-between mb-2">
                      <h3 className="text-lg font-semibold text-light-accent dark:text-gumroad-pink">{repo.repo}</h3>
                      {repo.language && (
