  ...
  return (
    <html lang="en" className="overflow-hidden h-screen">
      <body className={`${inter.className} bg-white text-neutral-900 dark:bg-neutral-900 dark:text-white overflow-hidden h-screen`}>
        <ThemeSwitcher />
        <div className="flex flex-col lg:flex-row min-h-screen w-full h-screen">
          {/* Hero Section - Full width on mobile, flexible width on desktop */}
          <div className="w-full lg:w-[35%] xl:w-[30%] flex-shrink-0 lg:sticky lg:top-0 lg:h-screen">
            <div className="w-full h-full flex items-center justify-center px-4 lg:px-8 py-8 lg:py-0">
              <Hero />
            </div>
          </div>
          
          {/* Content Section - Full width on mobile, flexible on desktop */}
          <div className="w-full lg:flex-1 flex items-start justify-center px-4 lg:px-8 py-4 lg:py-8 h-full">
            <div className="w-full h-full lg:h-[96vh] bg-white dark:bg-gumroad-dark rounded-3xl shadow-2xl border border-neutral-200 dark:border-neutral-800 p-4 lg:p-10 flex flex-col overflow-hidden">
              <ContentWrapper />
            </div>
          </div>
        </div>
