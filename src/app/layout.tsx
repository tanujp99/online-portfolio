        ...
        <ThemeProvider>
          ...
          <div className="block lg:hidden h-full flex flex-col overflow-hidden">
            ...
            <div className="flex-1 px-6 pb-6 min-h-0">
              <div style={{ '--i': 3 } as React.CSSProperties} className="hero-in h-full bg-[var(--card-bg)] backdrop-blur-xl rounded-2xl p-5 flex flex-col overflow-hidden shadow-main">
                <ContentWrapper />
              </div>
            </div>
          </div>
          ...
          <div className="hidden lg:flex min-h-screen w-full h-screen">
            ...
            <div className="flex-1 flex items-start justify-center px-8 xl:px-12 py-8 xl:py-12 h-full">
              <div style={{ '--i': 3 } as React.CSSProperties} className="hero-in w-full h-[calc(100vh-64px)] xl:h-[calc(100vh-96px)] bg-[var(--card-bg)] backdrop-blur-xl rounded-2xl p-8 flex flex-col overflow-hidden shadow-main">
                <ContentWrapper />
              </div>
            </div>
          </div>
